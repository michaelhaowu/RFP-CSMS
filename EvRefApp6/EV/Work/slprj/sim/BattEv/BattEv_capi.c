...
rtDimensionArray } , "float" , { 2680136941U , 753976687U , 1220811411U ,
3598222734U } , & mmiStaticInfoLogging , 0 , 0 } ; const
...
DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetInstanceLoggingInfo ( n4jdqa0poy
-> DataMapInfo . mmi , & n4jdqa0poy -> DataMapInfo . mmiLogInstanceInfo ) ;
rtwCAPI_SetChildMMIArray ( n4jdqa0poy -> DataMapInfo . mmi , ( NULL ) ) ;
rtwCAPI_SetChildMMIArrayLen ( n4jdqa0poy -> DataMapInfo . mmi , 0 ) ;
BattEv_InitializeSystemRan ( n4jdqa0poy , n4jdqa0poy -> DataMapInfo .
systemRan , localDW , n4jdqa0poy -> DataMapInfo . systemTid , sysRanPtr ,
contextTid ) ; rtwCAPI_SetSystemRan ( n4jdqa0poy -> DataMapInfo . mmi ,
n4jdqa0poy -> DataMapInfo . systemRan ) ; rtwCAPI_SetSystemTid ( n4jdqa0poy
-> DataMapInfo . mmi , n4jdqa0poy -> DataMapInfo . systemTid ) ;
rtwCAPI_SetGlobalTIDMap ( n4jdqa0poy -> DataMapInfo . mmi , & n4jdqa0poy ->
